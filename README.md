...
|            |           |                                                                                                                                            |                             |                                                                                                                 |
| ---------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------- | --------------------------------------------------------------------------------------------------------------- |
| ICLR'22    | GCond     | 📌[Graph Condensation for Graph Neural Networks](https://arxiv.org/abs/2110.07580)                                                         | Wei Jin et al.              | [\[code\]](https://github.com/chandlerbang/gcond) ⭐ 147 \| 🐛 11 \| 🌐 Python \| 📅 2025-10-10                  |
...
* [Awesome-graph-reduction](https://github.com/ChandlerBang/awesome-graph-reduction) ⭐ 189 | 🐛 0 | 📅 2026-02-25
